...
def main():
    ...
    data = {"train_file": str(DATA_DIR / 'thumbnail_train.pt'), # 20250809
            "valid_file": str(DATA_DIR / 'thumbnail_val.pt'),
            "test_file": str(DATA_DIR / 'thumbnail_test.pt'),
            "train_pts" : dpt_train,
            "vald_pts"  : dpt_valid,
            "test_pts"  : dpt_valid,
...
if __name__=='__main__':
    ...
    DATA_DIR = ROOT.parent / "data_sets"
    yaml_config_path = ROOT / "main_config.yaml"
